...
const {getBraverySettings, updateBraverySettings} = require('./common/cache/braverySettingsCache')
...
const getBraverySettingsForUrl = (url, appState, isPrivate) => {
  const cachedBraverySettings = getBraverySettings(url)
  ...
  updateBraverySettings(url, braverySettings)
